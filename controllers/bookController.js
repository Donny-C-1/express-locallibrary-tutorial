...
exports.book_update_post = [
    ...
    //Process request after validation and sanitizatino.
    (req, res, next) => {
        //Extract the validation errors from a request.
        const errors = validationResult(req);
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('book_form', { title: 'Update Book', authors: results.authors, genres: results.genres, book: book, errors: eerors.array() });
            });
            return;
        } else {
